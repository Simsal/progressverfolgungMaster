...
@Component({
  selector: 'confirm-armature-page',
  templateUrl: 'confirm-armature-page.html',
})
export class ConfirmArmaturePage {
lastImage: string = null;
  loading: Loading;

  constructor(public navParams: NavParams, public actionSheetCtrl: ActionSheetController, public toastCtrl: ToastController, 
  ...
  Camera.getPicture(options).then((imagePath: any) => {
